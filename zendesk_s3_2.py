...
if __name__ == "__main__"    :     
    ...
    for i in lista :
        ...
        engine = create_engine("postgresql+psycopg2://{user}:{contr}@{host}:5439/{base}".format(user = '', 
                                                                                            ...
                                                                                            base='', 
                                                                                            host=''  ), 
                               connect_args={'options': '-csearch_path={}'.format('zendesk_tickets')}, echo = False)
...
#        tabla.to_csv("tickets.csv", index = False, mode = 'a')
#        history.to_csv("history.csv", index = False, mode = 'a')
#        webpath.to_csv("webpath.csv", index = False, mode = 'a')
